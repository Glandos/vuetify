...
In its simplest form, v-progress-circular displays a circular progress bar. Use the value prop to control the progress.In its simplest form, v-progress-linear displays a horizontal progress bar. Use the value prop to control the progress.
